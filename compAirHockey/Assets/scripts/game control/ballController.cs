	...
	void Update () {
		...
		if(transform.position.x < -10f){
			...
			if (Application.loadedLevelName == "Level2"){
				ScoreController1.instance2.GivePlayer2APoint1 ();
			}
			if (Application.loadedLevelName == "Level3") {
				ScoreController2.instance3.GivePlayer2APoint2 ();
			}
			StartCoroutine (Pause ());
		...
		if(transform.position.x > 866f){
			...
			if (Application.loadedLevelName == "Level2"){
			ScoreController1.instance2.GivePlayer1APoint1 ();
			}
			if (Application.loadedLevelName == "Level3") {
				ScoreController2.instance3.GivePlayer1APoint2 ();
			}
			StartCoroutine (Pause ());
